                    ...
                    <div class="col-lg-8">
                        <div class="single-recipe-layout1">
                            ...
                            <div class="item-figure">
                                <img src="/app/img/product/single-product1.jpg" alt="Product">
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-xl-4 col-lg-6 col-md-6 col-12">
                                        <div class="product-box-layout2">
                                            <figure class="item-figure"><img src="/app/img/product/product11.jpg"
                                                        alt="Product"></figure>
                                            <div class="item-content">
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6 col-12">
                                        <div class="product-box-layout2">
                                            <figure class="item-figure"><img src="/app/img/product/product12.jpg"
                                                        alt="Product"></figure>
                                            <div class="item-content">
                                    ...
                                    <div class="col-xl-4 d-block d-md-none d-xl-block col-12">
                                        <div class="product-box-layout2">
                                            <figure class="item-figure"><img src="/app/img/product/product13.jpg"
                                                        alt="Product"></figure>
                                            <div class="item-content">
