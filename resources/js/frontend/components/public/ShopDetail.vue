<template>
  <div id="shop-detail">
      ...
      <div class="container">
        <div class="row">
                  ...
                  <div class="tab-content">
                    <div class="tab-pane fade active show" id="related1">
                      <a href="#">
                        <img
                          alt="single"
                          src="/app/img/product/shop-figure14.png"
                          data-zoom-image="/app/img/product/product27b.png"
                        />
                      </a>
                    </div>
                    <div class="tab-pane fade" id="related2">
                      <a href="#">
                        <img
                          alt="single"
                          src="/app/img/product/shop-figure15.png"
                          data-zoom-image="/app/img/product/product27-1b.png"
                        />
                      </a>
                    </div>
                    <div class="tab-pane fade" id="related3">
                      <a href="#">
                        <img
                          alt="single"
                          src="/app/img/product/shop-figure16.png"
                          data-zoom-image="/app/img/product/product27-2b.png"
                        />
                      </a>
                    </div>
                    <div class="tab-pane fade" id="related4">
                      <a href="#">
                        <img
                          alt="single"
                          src="/app/img/product/shop-figure17.png"
                          data-zoom-image="/app/img/product/product27-3b.png"
                        />
                      </a>
                    </div>
                  </div>
                  ...
                  <ul class="nav tab-nav tab-nav-list">
                    <li class="nav-item">
                      <a class="active" href="#related1" data-toggle="tab" aria-expanded="false">
                        <img
                          alt="related1"
                          src="/app/img/product/shop-figure10.png"
                          class="img-fluid"
                        />
                      </a>
                    </li>
                    <li class="nav-item">
                      <a href="#related2" data-toggle="tab" aria-expanded="false">
                        <img
                          alt="related2"
                          src="/app/img/product/shop-figure11.png"
                          class="img-fluid"
                        />
                      </a>
                    </li>
                    <li class="nav-item">
                      <a href="#related3" data-toggle="tab" aria-expanded="false">
                        <img
                          alt="related3"
                          src="/app/img/product/shop-figure12.png"
                          class="img-fluid"
                        />
                      </a>
                    </li>
                    <li class="nav-item">
                      <a href="#related4" data-toggle="tab" aria-expanded="false">
                        <img
                          alt="related4"
                          src="/app/img/product/shop-figure13.png"
                          class="img-fluid"
                        />
                      </a>
                    </li>
          ...
          <div class="col-lg-5 col-12">
            <div class="single-shop-content">
              <h2 class="item-title">Kitchen Key Spone</h2>
              <ul class="item-rate">
                <li>
              ...
              <p
                class="item-details"
              >Working from home meant we couldsnack and coffee our breaksert change our desks or view, good, drink on the job, even spend the weather started getting. Working from home meant we couldsnack and coffee our breaksert change.</p>
              <ul class="action-area1">
          ...
          <div class="col-12">
            <div class="single-shop-description">
              <ul class="nav nav-tabs tab-nav-list">
                ...
                <li class="nav-item">
                  <a href="#related6" data-toggle="tab" aria-expanded="false">Features</a>
                </li>
                <li class="nav-item">
              ...
              <div class="tab-content">
                <div
                  ...
                  id="related5"
                >Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semperauris placerat eleifen deleo.</div>
                <div class="tab-pane fade" id="related6">
                  Gimply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five
                  centuries, but also the leap into electronic typesetting, remaining essentially unchanged mply dummy text of the printing and typesetting industry. Gimply dummy text of the printing and typesetting industry. Lorem Ipsum
        ...
        <div class="related-product">
          <div class="section-heading heading-dark">
            <h2 class="item-heading">REALATED PRODUCTS</h2>
          </div>
          <div
            class="rc-carousel dot-control-layout1"
            data-loop="true"
            data-items="9"
            data-margin="30"
            data-autoplay="true"
          ...
          >
            ...
            <div class="shop-box-layout1">
              <div class="mask-item bg--accent">
                <div class="item-figure">
                  <img src="/app/img/product/shop-figure7.png" alt="Product" />
                </div>
                <ul class="action-items">
                  <li>
                    <a href="#">
            ...
            <div class="shop-box-layout1">
              <div class="mask-item bg--accent">
                <div class="item-figure">
                  <img src="/app/img/product/shop-figure8.png" alt="Product" />
                </div>
                <ul class="action-items">
                  <li>
                    <a href="#">
            ...
            <div class="shop-box-layout1">
              <div class="mask-item bg--accent">
                <div class="item-figure">
                  <img src="/app/img/product/shop-figure9.png" alt="Product" />
                </div>
                <ul class="action-items">
                  <li>
                    <a href="#">
    ...
    <!-- Single Shop Page Area End Here -->
  </div>
</template>
