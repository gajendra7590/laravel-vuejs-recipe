    ...
    <div id="wrapper" class="wrapper"> 
            ...
            <div class="container">
                <div class="rc-carousel nav-control-layout2" data-loop="true" data-items="30" data-margin="5"
                    ...
                    <div class="ranna-slider-content-layout1">
                        <figure class="item-figure"><a href="single-recipe1.html"><img src="/app/img/slider/slide1-1.jpg" alt="Product"></a></figure>
                    ...
                    <div class="ranna-slider-content-layout1">
                        <figure class="item-figure"><a href="single-recipe1.html"><img src="/app/img/slider/slide1-2.jpg" alt="Product"></a></figure>
                        <div class="item-content">
                            <span class="sub-title">SALAD</span>
                            <h2 class="item-title"><a href="single-recipe1.html">Italiano Salad Mixed</a></h2>
                            <ul class="item-rating">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="product-box-layout1">
                            <figure class="item-figure"><a href="single-recipe1.html"><img src="/app/img/product/product1.jpg"
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="product-box-layout1">
                            <figure class="item-figure"><a href="single-recipe1.html"><img src="/app/img/product/product2.jpg"
                                        alt="Product"></a></figure>
                            <div class="item-content">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 col-12">
                                <div class="product-box-layout1">
                                    <figure class="item-figure"><a href="single-recipe1.html"><img src="/app/img/product/product5.jpg"
                                                alt="Product"></a></figure>
                                    <div class="item-content">
                            ...
                            <div class="col-md-6 col-sm-6 col-12">
                                <div class="product-box-layout1">
                                    <figure class="item-figure"><a href="single-recipe1.html"><img src="/app/img/product/product6.jpg"
                                                alt="Product"></a></figure>
                                    <div class="item-content">
                                        <span class="sub-title">SALAD</span>
                            ...
                            <div class="col-md-6 col-sm-6 col-12">
                                <div class="product-box-layout1">
                                    <figure class="item-figure"><a href="single-recipe1.html"><img src="/app/img/product/product7.jpg"
                                                alt="Product"></a></figure>
                                    <div class="item-content">
                            ...
                            <div class="col-md-6 col-sm-6 col-12">
                                <div class="product-box-layout1">
                                    <figure class="item-figure"><a href="single-recipe1.html"><img src="/app/img/product/product8.jpg"
                                                alt="Product"></a></figure>
                                    <div class="item-content">
                                        <span class="sub-title">JUICE</span>
                            ...
                            <div class="col-md-6 col-sm-6 col-12">
                                <div class="product-box-layout1">
                                    <figure class="item-figure"><a href="single-recipe1.html"><img src="/app/img/product/product9.jpg"
                                                alt="Product"></a></figure>
                                    <div class="item-content">
                                        <span class="sub-title">BREAKFAST</span>
                            ...
                            <div class="col-md-6 col-sm-6 col-12">
                                <div class="product-box-layout1">
                                    <figure class="item-figure"><a href="single-recipe1.html"><img src="/app/img/product/product10.jpg"
                                                alt="Product"></a></figure>
                                    <div class="item-content">
                                        <span class="sub-title">DINNER</span>
                                        <h3 class="item-title"><a href="single-recipe1.html">Asian Chicken Noodles</a></h3>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                        <div class="product-box-layout2">
                            <figure class="item-figure"><a href="single-recipe1.html"><img src="/app/img/product/product11.jpg"
                                        alt="Product"></a></figure>
                            <div class="item-content">
                                <span class="sub-title">BREAKFAST</span>
                                <h3 class="item-title"><a href="single-recipe1.html">Tomatoes Stuffed with Foie and
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                        <div class="product-box-layout2">
                            <figure class="item-figure"><a href="single-recipe1.html"><img src="/app/img/product/product12.jpg"
                                        alt="Product"></a></figure>
                            <div class="item-content">
                                <span class="sub-title">DESERT</span>
                                <h3 class="item-title"><a href="single-recipe1.html">Pumpkin Cheesecake With
                ...
                <div class="row gutters-60">
                    <div class="col-lg-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="product-box-layout3">
                                    <figure class="item-figure"><a href="single-recipe1.html"><img src="/app/img/product/product15.jpg"
                                                alt="Product"></a></figure>
                                    <div class="item-content">
                            ...
                            <div class="col-xl-12 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="product-box-layout3">
                                    <figure class="item-figure"><a href="single-recipe1.html"><img src="/app/img/product/product16.jpg"
                                                alt="Product"></a></figure>
                                    <div class="item-content">
                                        <span class="sub-title">SALAD</span>
                                        <h3 class="item-title"><a href="single-recipe1.html">Maxican Dessert</a></h3>
        ...
        <section class="instagram-feed-wrap">
            ...
            <ul class="instagram-feed-figure">
                ...
                <li>
                    <a href="single-recipe1.html"><img src="/app/img/social-figure/social-figure2.jpg" alt="Social"></a>
                </li>
                <li>
                    <a href="single-recipe1.html"><img src="/app/img/social-figure/social-figure3.jpg" alt="Social"></a>
                </li>
                <li>
                    <a href="single-recipe1.html"><img src="/app/img/social-figure/social-figure4.jpg" alt="Social"></a>
                </li>
                <li>
                    <a href="single-recipe1.html"><img src="/app/img/social-figure/social-figure5.jpg" alt="Social"></a>
                </li>
                <li>
                    <a href="single-recipe1.html"><img src="/app/img/social-figure/social-figure6.jpg" alt="Social"></a>
                </li>
                <li>
                    <a href="single-recipe1.html"><img src="/app/img/social-figure/social-figure7.jpg" alt="Social"></a>
                </li>
                <li>
                    <a href="single-recipe1.html"><img src="/app/img/social-figure/social-figure8.jpg" alt="Social"></a>
                </li>
            </ul>
        </section>
        <!-- Instagram End Here --> 
