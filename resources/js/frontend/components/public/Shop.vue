            ...
            <div class="container">
                <div class="row gutters-60">
                    <div class="col-lg-8">
                        <div class="d-sm-flex justify-content-between align-items-center">
                            <div class="section-heading heading-dark">
                                <h2 class="item-heading">SHOWING 16-24 OF 50 RESULTS</h2>
                            </div>
                    ...
                    <div class="col-lg-4 sidebar-widget-area sidebar-break-md">
                        ...
                        <div class="widget">
                            <div class="section-heading heading-dark">
                                <h3 class="item-heading">TOP PRODUCTS</h3>
                            </div>
                            <div class="widget-top-product">
                                <ul class="block-list">
                                    <li class="single-item">
                                        <div class="item-img">
                                            <a href="single-shop.html" class="item-icon"><i class="flaticon-plus-1"></i></a>
                                            <img src="/app/img/product/top-product1.jpg" alt="Post">
                                        </div>
                                        <div class="item-content">
                                            <h4 class="item-title"><a href="#">Kitchen Product</a></h4>
                                            <div class="item-price"><span class="item-currency">$</span>15.00</div>
                                        </div>
                                    </li>
                                    <li class="single-item">
                                        <div class="item-img">
                                            <a href="single-shop.html" class="item-icon"><i class="flaticon-plus-1"></i></a>
                                            <img src="/app/img/product/top-product2.jpg" alt="Post">
                                        </div>
                                        <div class="item-content">
                                            <h4 class="item-title"><a href="#">Kitchen Product</a></h4>
                                            <div class="item-price"><span class="item-currency">$</span>25.00</div>
                                        </div>
                                    </li>
                                    <li class="single-item">
                                        <div class="item-img">
                                            <a href="single-shop.html" class="item-icon"><i class="flaticon-plus-1"></i></a>
                                            <img src="/app/img/product/top-product3.jpg" alt="Post">
                                        </div>
                                        <div class="item-content">
                                            <h4 class="item-title"><a href="#">Kitchen Product</a></h4>
                                            <div class="item-price"><span class="item-currency">$</span>29.00</div>
                                        </div>
                                    </li>
                                    <li class="single-item">
                                        <div class="item-img">
                                            <a href="single-shop.html" class="item-icon"><i class="flaticon-plus-1"></i></a>
                                            <img src="/app/img/product/top-product4.jpg" alt="Post">
                                        </div>
                                        <div class="item-content">
                                            <h4 class="item-title"><a href="#">Kitchen Product</a></h4>
                                            <div class="item-price"><span class="item-currency">$</span>10.00</div>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="widget">
                            <div class="widget-ad">
                                <a href="#"><img src="/app/img/figure/figure5.jpg" alt="Ad" class="img-fluid"></a>
                            </div>
                        </div>
                    </div>
                </div>
