        ...
        <div class="row gutters-60">
          ...
          <div class="col-lg-4 sidebar-widget-area sidebar-break-md">
              ...
              <div class="widget-top-product">
                <ul class="block-list">
                  <li class="single-item">
                    <div class="item-img">
                      <a href="single-shop.html" class="item-icon">
                    ...
                    <div class="item-content">
                      <h4 class="item-title">
                        <a href="#">Kitchen Product</a>
                      </h4>
                      <div class="item-price">
                        <span class="item-currency">$</span>15.00
                      </div>
                    </div>
                  </li>
                  <li class="single-item">
                    ...
                    <div class="item-content">
                      ...
                      <div class="item-price">
                        <span class="item-currency">$</span>25.00
                      </div>
                    </div>
                  </li>
                  <li class="single-item">
                    ...
                    <div class="item-content">
                      ...
                      <div class="item-price">
                        <span class="item-currency">$</span>29.00
                      </div>
                    </div>
                  </li>
                  <li class="single-item">
                    ...
                    <div class="item-content">
                      ...
                      <div class="item-price">
                        <span class="item-currency">$</span>10.00
                      </div>
                    </div>
                  </li>
                </ul>
            ...
            <div class="widget">
              <div class="widget-ad">
                <a href="#">
                  <img src="/app/img/figure/figure5.jpg" alt="Ad" class="img-fluid" />
                </a>
              </div>
            </div>
          </div>
