...
const router = new VueRouter({
    ...
    routes: [
        ...
        //Blogs Routes
        { name: "blogs-list", path: "/blogs", component: BlogsList, meta: { protectedURL: true } },
        { name: "edit-blog", path: "/edit-blog/:id", component: BlogsForm, meta: { protectedURL: true } },
        { name: "add-blog", path: "/add-blog", component: BlogsForm, meta: { protectedURL: true } },
        //Blog Categories Routes
        { name: "blog-categories-list", path: "/blog-categories", component: BlogCategoriesList, meta: { protectedURL: true } },
        { name: "blog-edit-category", path: "/edit-blog-category/:id", component: BlogCategoryForm, meta: { protectedURL: true } },
        { name: "blog-add-category", path: "/add-blog-category", component: BlogCategoryForm, meta: { protectedURL: true } },
        //Blog Tags Routes
        { name: "blog-tags-list", path: "/blog-tags", component: BlogTagsList, meta: { protectedURL: true } },
        { name: "blog-edit-tag", path: "/edit-blog-tag/:id", component: BlogTagsForm, meta: { protectedURL: true } },
        { name: "blog-add-tag", path: "/add-blog-tag", component: BlogTagsForm, meta: { protectedURL: true } },
        //Users Routes
